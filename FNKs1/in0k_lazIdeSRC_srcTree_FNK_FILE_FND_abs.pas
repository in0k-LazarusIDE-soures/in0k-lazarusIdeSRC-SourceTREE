...
function SrcTree_fndFileABS(const item:_tSrcTree_item_fsNodeFLDR_; const fileName:string):_tSrcTree_item_fsNodeFILE_;

function SrcTree_fndFileABS(const item:tSrcTree_fsFLDR; const fileName:string):_tSrcTree_item_fsNodeFILE_;


function SrcTree_fndFileABS(const item:tSrcTree_ROOT; const fileName:string):_tSrcTree_item_fsNodeFILE_;
